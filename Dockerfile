...
COPY --from=builder /app/virtocommerce-adapter/dist virtocommerce-adapter/dist
COPY --from=prod-deps /app/virtocommerce-adapter/node_modules virtocommerce-adapter/node_modules
COPY virtocommerce-adapter/package.json virtocommerce-adapter/
